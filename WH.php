		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" method="post"action="WareHouseController.php" onsubmit="return registrationValidate();">
                    ...
                    <h4 style="font-family:Arial Black;">* Add New WareHouse</h4><br>
                    <!-- WareHouse Name -->
					<div class="wrap-input100 validate-input m-b-23" data-validate = "WareHouse Name is reauired">
						...
						<input class="input100" type="text" id="firstName" name="Name" placeholder="  Enter the WAREHOUSE name" value="" onblur="checkFName()">
                    ...
                    <!-- Delete WareHouse -->
                    <h4 style="font-family:Arial Black;">* Delete Existing WareHouse</h4><br>
                    <h5>* Please Select The WareHouse You Would Like To Delete</h5><br>
                <div class="wrap-input100 validate-input m-b-23" data-validate = "WareHouse Name is reauired">
                    <select name="Drop">
                    <?php 
                ...
                <!-- Delete Button -->
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							<div class="login100-form-bgbtn"></div>
							<button class="login100-form-btn" name="Delete" value="Submit">
								Delete WareHouse
							</button>
						</div>
					</div><br><br>
